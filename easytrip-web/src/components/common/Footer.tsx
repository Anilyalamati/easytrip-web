      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
        ...
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-sm bg-brand-50 border border-brand-200/80 flex items-center justify-center p-1 shadow-sm">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold uppercase px-1.5 py-0.5 rounded-sm bg-brand-50 text-brand-700 border border-brand-200 tracking-wider">
                PRO
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-1">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-emerald-50 border border-emerald-200 text-[11px] font-medium text-emerald-700">
