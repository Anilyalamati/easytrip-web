  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        {/* Center Desktop Navigation with Smooth Motion */}
        <nav className="hidden lg:flex items-center gap-1 bg-slate-100/90 p-1.5 rounded-full border border-slate-200/90 relative">
          <button
            onClick={() => navigateToSection('explore', 'dashboard')}
            className={`relative z-10 px-3.5 py-1.5 rounded-full text-xs font-semibold tracking-normal transition-all duration-200 flex items-center gap-1.5 active:scale-95 ${
          ...
          <button
            ...
            className="relative z-10 px-3.5 py-1.5 rounded-full text-xs font-semibold text-charcoal-600 hover:text-midnight-900 hover:bg-white/60 transition-all duration-200 flex items-center gap-1.5 active:scale-95"
          >
        ...
        {/* Right Actions & CTAs with Spring Feedback */}
        <div className="flex items-center gap-2 sm:gap-2.5">
          {/* Saved Trips Trigger */}
          <button
            onClick={() => setIsSavedTripsOpen(true)}
            className="relative p-2.5 rounded-xl bg-white border border-slate-200 text-charcoal-700 hover:text-brand-600 hover:border-brand-300 hover:shadow-sm transition-all duration-200 active:scale-90"
            title="Saved Trips"
          >
            <Bookmark className="w-4 h-4" />
            {savedTrips.length > 0 && (
              <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-brand-600 text-white text-[10px] font-bold flex items-center justify-center shadow animate-marker-pop">
                {savedTrips.length}
              </span>
            )}
          </button>
          ...
          >
            ...
            {totalCartCount > 0 && (
              <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-teal-600 text-white text-[10px] font-bold flex items-center justify-center shadow animate-marker-pop">
                {totalCartCount}
              </span>
            )}
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-safety-50 border border-safety-200 text-safety-700 hover:bg-safety-100 hover:border-safety-300 text-xs font-bold transition-all duration-200 active:scale-95 shadow-sm"
          ...
          <button
            ...
            className="btn-primary hidden sm:flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold text-xs tracking-normal"
          >
          ...
          <button
            ...
            className="lg:hidden p-2.5 rounded-xl bg-white border border-slate-200 text-charcoal-700 hover:text-midnight-900 transition-all active:scale-90"
